...
const SocialLink = ({ href, label, icon, hoverColor, delay }) => (
  <motion.a
    href={href}
    target="_blank"
    rel="noreferrer"
    ...
    whileTap={{ scale: 0.95 }}
    className={`w-10 h-10 rounded-xl bg-white/10 dark:bg-gray-700/50 border border-white/20 dark:border-gray-600 flex items-center justify-center text-gray-500 dark:text-gray-400 transition-all duration-300 ${hoverColor} hover:border-current hover:bg-white/20`}
  >
    {icon}
  </motion.a>
);
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 border-t border-gray-200 dark:border-gray-800">
      {/* Top gradient line */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6 items-start">
          ...
          >
            <div className="flex items-center gap-1 justify-center md:justify-start">
              <span className="text-blue-400 font-black text-xl leading-none" style={{ fontFamily: "'Poppins', sans-serif" }}>{"<"}</span>
              <span className="flex flex-col leading-none">
                <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-gray-400 dark:text-gray-500" style={{ fontFamily: "'Poppins', sans-serif" }}>Vishwajeet</span>
                <span className="text-lg font-black bg-gradient-to-r from-blue-600 to-green-500 bg-clip-text text-transparent" style={{ fontFamily: "'Poppins', sans-serif", letterSpacing: "-0.03em" }}>Kumar</span>
              </span>
              <span className="text-green-400 font-black text-xl leading-none" style={{ fontFamily: "'Poppins', sans-serif" }}>{"/>"}</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-xs">
              Building pixel-perfect digital experiences with passion and precision.
            </p>
          ...
          >
            <h3 className="text-sm font-bold text-gray-800 dark:text-white uppercase tracking-widest mb-1">Contact</h3>
            <a
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">India · Remote Friendly</span>
          </motion.div>
          ...
          >
            <h3 className="text-sm font-bold text-gray-800 dark:text-white uppercase tracking-widest">Follow Me</h3>
            <div className="flex gap-3">
              ...
              />
              <SocialLink
                href="https://www.instagram.com/vishwajeet_kr076/"
                label="Instagram"
        ...
        <motion.div
          ...
          className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-3 text-center"
        >
          <p className="text-sm text-gray-400 dark:text-gray-500">
            © {year} FreelanceNest · Vishwajeet Kumar. All rights reserved.
          </p>
