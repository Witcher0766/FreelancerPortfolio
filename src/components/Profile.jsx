...
const Profile = () => {
  return (
    <>
           <div className="flex flex-col md:flex-row  items-center md:items-start justify-between md:justify-around max-w-7xl mx-auto p-4  h-auto md:h-[65vh] lg:h-[65vh]  ">
